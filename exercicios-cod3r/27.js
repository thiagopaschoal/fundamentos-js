const crescimento = (crianca1, crianca2) => {
  ...
  if (altura1 < altura2) {
    ...
    console.log(
      `A criança 1 é menor que a criança 2, faltando assim ${anosFaltantes.toFixed(
        1
      )} anos para ela ficar da altura da criança 2`
    );
  } else {
    const anosFaltantes = (altura1 - altura2) / taxa2;
    console.log(
      `A criança 2 é menor que a criança 1, faltando assim ${anosFaltantes} anos para ela ficar da altura da criança 1`
    );
  }
};
